...
languageBtn.addEventListener('click', ()=>{
    ...
    if(language==='Spanish'){
        ...
        cake.innerText= 'Cake'
        cakeDef.innerText= 'Regular cake or made with tres leches. Can be made with fruit filling. Perfect for a special occasion!'
        tresDef.innerText ='Legendary tres leches cake, extra wet and a pinch of cinnamon!'
        cupDef.innerText = 'Fresh made delicious cupcakes. Comes in a variety of flavors!'
